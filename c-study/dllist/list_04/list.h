...
/*
 * Simple doubly link list implementation.
 *
...
/**
 * iterate over a list invertedly
 * @param pos:	the &struct list_head to use as a loop cursor.
 * @param head:	the head for your list.
 */
#define list_for_each_inverted(pos, head) \
...
/**
 * iterate over a list safe against removal of list entry invertedly
 * @param pos:	the &struct list_head to use as a loop cursor.
 * @param n:		another &struct list_head to use as temporary storage
 * @param head:	the head for your list.
 */
#define list_for_each_safe_inverted(pos, n, head) \
