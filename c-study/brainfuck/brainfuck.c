 ...
 */
BrainfuckInstruction *brainfuck_add(BrainfuckState * state, BrainfuckInstruction * instruction)
{
    if (state == NULL || instruction == NULL)
        return NULL;
 ...
 * @return The new head of the linked list.
 */
BrainfuckInstruction *brainfuck_add_front(BrainfuckState * state, BrainfuckInstruction * instruction)
{
    if (state == NULL || instruction == NULL)
        return NULL;
    instruction->previous = 0;
